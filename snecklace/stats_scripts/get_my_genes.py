...
def get_no_annot_genes(annot):
    attributes = pd.read_table(annot, sep="\t", usecols=[8], skiprows=2)
...
if __name__ == '__main__':
    ...
    new_string = "/home/sarah/packages/snecklace/snecklace06/compat-nlace1/genome_guided_assembly/demo_assembly.gtf"
    n = get_no_annot_genes(new_string)
